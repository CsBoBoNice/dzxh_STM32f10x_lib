...
/***********************************USART1***************************************/
#ifdef USING_USART1
#define USART1_BUF_SIZE 			1024		//接收一、二级缓冲区大小
#define USART1_RECEIVE_OVERTIME		100			//字节超时时间, 单位为ms
...
#ifdef USING_USART2
#define USART2_BUF_SIZE				1024	//接收一、二级缓冲区大小	
...
#ifdef USING_USART3
#define USART3_BUF_SIZE				1024	//接收一、二级缓冲区大小
#define USART3_RECEIVE_OVERTIME		300		//字节超时时间, 单位为ms
...
#ifdef USING_UART4
#define UART4_BUF_SIZE				1024	//接收一、二级缓冲区大小
#define UART4_RECEIVE_OVERTIME		300		//字节超时时间, 单位为ms	
...
#ifdef USING_UART5
#define UART5_BUF_SIZE				1024	//接收一、二级缓冲区大小
#define UART5_RECEIVE_OVERTIME		300		//字节超时时间, 单位为ms	
